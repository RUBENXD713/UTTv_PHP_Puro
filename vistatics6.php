    ...
    <header id="base">
        <div class="letf_area">
          ...
          <div class="container" id="busqueda" style="text-align: center;">
            ...
            <p style="text-align: center;" class="videossss">Video de: TICS</p>
            <div class="videossss">
    <table class="default" style="text-align: righ;">
      <tr>
          <td class="separation">

          <iframe width="850" height="450" src="https://www.youtube.com/embed/tyx05coXixw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>    
