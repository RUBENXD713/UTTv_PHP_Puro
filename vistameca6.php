...
<body id="fondo">
    ...
    <table class="default" style="text-align: righ;">
      <tr>
          <td class="separation">
          <iframe width="850" height="450" src="https://www.youtube.com/embed/bxcg8eVYRz8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
