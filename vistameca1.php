          ...
          <div class="container" id="menu">
            <div class="row g-2">
               <center> 
                ...
                <a style="text-decoration:none" href="resources/views/welcome.blade.php">
    ...
    <table class="default" style="text-align: righ;">
      <tr>
          <td class="separation">
              ...
              <iframe width="850" height="450" src="https://www.youtube.com/embed/eBVvD85Ml2c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
